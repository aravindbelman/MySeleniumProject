...
// This test is to create STARR marine submission with all valid Fields

@Listeners({com.LegacyApplication.CustomListner.ExecutionListner.class, com.LegacyApplication.CustomListner.Listner.class, com.LegacyApplication.CustomListner.RetryListner.class})
public class TC091_CreateStarr_MarineArt_Sub extends TestBase {

	public static final Logger log= Logger.getLogger(TC091_CreateStarr_MarineArt_Sub.class.getName());

	@Test
	public static void starr_marineSubmission() throws IOException, InterruptedException, Exception, AWTException
	{
