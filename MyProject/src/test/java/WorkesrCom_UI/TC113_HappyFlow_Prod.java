...
public class TC113_HappyFlow_Prod  extends TestBase{
	public static final Logger log= Logger.getLogger(TC113_HappyFlow_Prod.class.getName());
	...
	{
		initialize_agency_environment("production_environment","chrome_browser");
		...
		log.info("======================== Employers Pass Successfully =====================");
	}
	...
	{	
		...
		WaitMethods.wait_for_element_present(WCnewUILocators.paymentBreakDown_pageHeading);
		log.info("======================== AMtrust Pass Successfully =====================");
	}
