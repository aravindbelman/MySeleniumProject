...
public class TC104_CreditOpportunity_Page7 extends TestBase{
	
	public static final Logger log= Logger.getLogger(TC104_CreditOpportunity_Page7.class.getName());
	
	@Test(enabled = true,priority=1)
	//To test Credit Opportunity page It Verify All available Question appear or Not
	// & Click YES/NO option accordingly
	public static void ts01_credit_Opportunity_verify()throws IOException, InterruptedException, Exception, AWTException
	{
