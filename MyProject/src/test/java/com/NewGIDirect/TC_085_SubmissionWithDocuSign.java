...
public class TC_085_SubmissionWithDocuSign  extends TestBase{
	
	public static final Logger log=Logger.getLogger(TC_085_SubmissionWithDocuSign.class.getName());
	@Test
	public static void createQAANewUI()throws  IOException, InterruptedException, Exception, AWTException
	{
		...
		WaitMethods.wait_in_seconds(25);
		GenericMethods.swith_to_default_content();
		GlDirectMethods.docuSign1();
		GlDirectMethods.docuSign2();
		//GlDirectMethods.docuSign();	
	}
