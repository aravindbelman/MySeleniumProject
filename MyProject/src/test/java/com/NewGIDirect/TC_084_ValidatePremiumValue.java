...
public class TC_084_ValidatePremiumValue extends TestBase
{
public static final Logger log=Logger.getLogger(TC_084_ValidatePremiumValue.class.getName());
	...
	public static void createQAA()throws  IOException, InterruptedException, Exception, AWTException
	{
		...
		GlDirectMethods.compair_PreQualifyValue_with_CoverageOption();
		GlDirectMethods.compair_allFileds_valuesfrom_CoverageOptions(1);
	}
