...
public class TC118_CBIC_UI_New extends TestBase{
	
	public static final Logger log= Logger.getLogger(TC118_CBIC_UI_New.class.getName());
	...
	public static void cbic_UI() throws IOException, InterruptedException, Exception, AWTException
	{
		...
		CBIC_New_UI_Methods.cbic_Classification(1,"double");
		GenericMethods.click_Element_Using_JS(CBIC_NewLocators.bi_save_contiunue_btn);
		WaitMethods.wait_in_seconds(5);
		
		CBIC_New_UI_Methods.cbic_BusinessInfo(1,"complete");
		GenericMethods.click_Element_Using_JS(CBIC_NewLocators.bi_save_contiunue_btn);
		WaitMethods.wait_in_seconds(2);
		...
		CBIC_New_UI_Methods.cbic_Supplemental("sub_Yes");
		GenericMethods.click_Element_Using_JS(CBIC_NewLocators.bi_save_contiunue_btn);
		WaitMethods.wait_in_seconds(5);
		...
		//class code 9111
		CBIC_New_UI_Methods.cbic_classCodeQuestionsfor_9111(1);
		WaitMethods.wait_in_seconds(2);
		
		GenericMethods.click_Element_Using_JS(CBIC_NewLocators.separator_btn);
		WaitMethods.wait_in_seconds(2);
		GenericMethods.click_Element_Using_JS(CBIC_NewLocators.separatorCollapsed_btn);
		
		//class code 92338
		CBIC_New_UI_Methods.cbic_classCodeQuestionsfor_92338();
		WaitMethods.wait_in_seconds(2);
