...
public class TC050_VerifyApplicationpage_QCA extends TestBase {
	public static final Logger log=Logger.getLogger(TC050_VerifyApplicationpage_QCA.class.getName());
	
	@Test
	public static void applicationpage_QCA() throws IOException, AWTException, InterruptedException {
		...
		CommercialAutoMethods.applicationpage_errorlist_QCA();
