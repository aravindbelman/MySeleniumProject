...
public class TC022_ValidateDifferentTieredBrokerFeeForNewandRenewal extends TestBase{

	public static final Logger log=Logger.getLogger(TC022_ValidateDifferentTieredBrokerFeeForNewandRenewal.class.getName());
	...
	public void setup_tiered_brokerfee() throws IOException, InterruptedException, AWTException
	{
		...
		AutoRenewalBrokerFeeMethods.validate_tiered_brokerfee("Renewal", 1);
