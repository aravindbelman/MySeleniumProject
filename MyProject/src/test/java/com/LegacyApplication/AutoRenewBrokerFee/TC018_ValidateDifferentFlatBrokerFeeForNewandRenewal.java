...
public class TC018_ValidateDifferentFlatBrokerFeeForNewandRenewal extends TestBase{

	public static final Logger log=Logger.getLogger(TC017_ValidateSameFlatBrokerFeeForNewandRenewal.class.getName());

	@Test
	public void setup_flat_brokerfee() throws IOException, InterruptedException, AWTException
	{
		...
		AutoRenewalBrokerFeeMethods.validate_flat_brokerFee("Flat Broker Fee for Renewal Business", 1);
		...
		AutoRenewalBrokerFeeMethods.validate_flat_brokerFee("Flat Broker Fee for Renewal Business", 1);
		AutoRenewalBrokerFeeMethods.update_brokerFee_value("flat", "renewal", 1);
		AutoRenewalBrokerFeeMethods.verify_payment_option(3);
		AutoRenewalBrokerFeeMethods.fill_bindingDoc_info("agencyfinance",1);
		AutoRenewalBrokerFeeMethods.verify_updated_brokerfee("Renewal Submission Id","Updated Flat Broker Fee for Renewal Business", 1);
		AutoRenewalBrokerFeeMethods.verify_payment_option(3);
	}
}