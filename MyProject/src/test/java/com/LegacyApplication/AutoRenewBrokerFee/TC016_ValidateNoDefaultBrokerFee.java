...
public class TC016_ValidateNoDefaultBrokerFee extends TestBase {
	
	public static final Logger log=Logger.getLogger(TC016_ValidateNoDefaultBrokerFee.class.getName());
	
	@Test
	public void validate_nodefault_brokerfee() throws IOException, InterruptedException, AWTException
	{
		...
		AutoRenewalBrokerFeeMethods.validate_nodefault_brokerFee("No Default BrokerFee for New Business", 1);
		AutoRenewalBrokerFeeMethods.update_brokerFee_value("nodefault", "new", 1);
		AutoRenewalBrokerFeeMethods.verify_payment_option(3);
		AutoRenewalBrokerFeeMethods.fill_bindingDoc_info("directbill",1);	
		AutoRenewalBrokerFeeMethods.verify_updated_brokerfee("Submission Id","Updated No Default BrokerFee for New Business", 1);
		AutoRenewalBrokerFeeMethods.verify_payment_option(3);
		WaitMethods.wait_in_seconds(5);
		...
		AutoRenewalBrokerFeeMethods.validate_nodefault_brokerFee("No Default BrokerFee Renewal Business", 1);
		AutoRenewalBrokerFeeMethods.update_brokerFee_value("nodefault", "renewal", 1);
		AutoRenewalBrokerFeeMethods.verify_payment_option(3);
		AutoRenewalBrokerFeeMethods.fill_bindingDoc_info("AgencyFinance",1);
		AutoRenewalBrokerFeeMethods.verify_updated_brokerfee("Renewal Submission Id", "Updated No Default BrokerFee Renewal Business", 1);
		AutoRenewalBrokerFeeMethods.verify_payment_option(3);
	}
