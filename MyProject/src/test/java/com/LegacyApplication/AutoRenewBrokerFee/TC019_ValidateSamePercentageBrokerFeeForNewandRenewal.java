...
public class TC019_ValidateSamePercentageBrokerFeeForNewandRenewal extends TestBase {

	public static final Logger log=Logger.getLogger(TC019_ValidateSamePercentageBrokerFeeForNewandRenewal.class.getName());
	...
	public void setup_percentage_brokerfee() throws IOException, InterruptedException, AWTException
	{
		...
		AutoRenewalBrokerFeeMethods.setup_brokerfee("percentage","same", 1);
