...
/*
 * HelixTkt No - 17595
 * 2nd scenario: Verify GABR - TX referral counties and
 * logic for  commercial project with less than 500,000 construction limit 
 */
...
public class TC084_GABRsubmission_withoutIssuePolicyOption45Com  extends TestBase {
	
	public static final Logger log= Logger.getLogger(TC084_GABRsubmission_withoutIssuePolicyOption45Com.class.getName());
	
	@Test
	public static void gabr_No_IssuePolicyOption_Commercial45() throws IOException, InterruptedException, AWTException
	{
