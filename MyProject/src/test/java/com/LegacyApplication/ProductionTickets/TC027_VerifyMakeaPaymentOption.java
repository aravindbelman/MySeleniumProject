...
public class TC027_VerifyMakeaPaymentOption extends TestBase {
	
	public static final Logger log= Logger.getLogger(TC027_VerifyMakeaPaymentOption.class.getName());
	
	
	
	@Test
	public void verify_make_payment_option() throws IOException, InterruptedException, AWTException
	{
		...
		WaitMethods.wait_in_seconds(5);
		AutoRenewalBrokerFeeMethods.verify_make_a_payment("Submission Id",1);
		AutoRenewalBrokerFeeMethods.fill_payment_info("eCheck", 1);
		WaitMethods.wait_in_seconds(35);
}
}
