...
public class TC042_VerifyGLTotalPayrollValueForNewAndRenwal extends TestBase {
	
	public static final Logger log=Logger.getLogger(TC042_VerifyGLTotalPayrollValueForNewAndRenwal.class.getName());
	
	@Test
	public static void verify_GL_totalPayroll() throws IOException, AWTException, InterruptedException
	{
	...
	GeneralLiabilityMethods.verify_total_payroll("Submission Id", 1);
	}
}
