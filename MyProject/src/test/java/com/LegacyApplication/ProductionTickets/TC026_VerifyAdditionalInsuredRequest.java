...
public class TC026_VerifyAdditionalInsuredRequest extends TestBase {

	public static final Logger log= Logger.getLogger(TC026_VerifyAdditionalInsuredRequest.class.getName());
	 ...
	 */
	@Test
	public void verify_additional_insured_request() throws IOException, InterruptedException, AWTException
	{
		...
		WaitMethods.wait_in_seconds(5);
		AutoRenewalBrokerFeeMethods.additional_insured_request("Submission Id",1);
