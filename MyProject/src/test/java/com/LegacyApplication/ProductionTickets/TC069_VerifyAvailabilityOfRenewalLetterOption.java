package com.LegacyApplication.ProductionTickets;
	...
	public class TC069_VerifyAvailabilityOfRenewalLetterOption extends TestBase {
		
		public static final Logger log=Logger.getLogger(TC069_VerifyAvailabilityOfRenewalLetterOption.class.getName());
		
		@Test
		public void review_submissionStatus_SpecialAgency_AgencyFinance() throws InterruptedException, IOException, AWTException
		{
			log.info("<===========Started verifying availability of Renewal Letter Option===========> ");
			...
			HomePageMethods.login_as_admin();
			WaitMethods.wait_in_seconds(5);
			GeneralLiabilityMethods.verify_renewal_letter_option("Renewal Submission Id", 1);
		    WaitMethods.wait_in_seconds(10);
				
			log.info("<===========Completed verifying the availability of Renewal Letter Option Test===========> ");
		}
