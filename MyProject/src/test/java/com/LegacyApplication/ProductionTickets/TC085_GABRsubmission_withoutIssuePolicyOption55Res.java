...
/*
 * HelixTkt No - 17595
 * 3rd scenario: Verify GABR - TX referral counties and 
 * logic for residential project with more than 500,000 construction limit
 */
...
public class TC085_GABRsubmission_withoutIssuePolicyOption55Res  extends TestBase{
	
	public static final Logger log= Logger.getLogger(TC085_GABRsubmission_withoutIssuePolicyOption55Res.class.getName());
	@Test
	public static void gabr_No_IssuePolicyOption_Resedential55() throws IOException, InterruptedException, AWTException
	{
		...
		BuildersRiskMethods.fill_br_rating_info(5);	
		WaitMethods.wait_in_seconds(3);
		WaitMethods.wait_for_page_load(5);	
		BuildersRiskMethods.fill_br_application_info(5);
		WaitMethods.wait_in_seconds(3);	
