...
public class TC029_VerifyEffectiveDateInInspectionReminder extends TestBase {
	
	public static final Logger log= Logger.getLogger(TC029_VerifyEffectiveDateInInspectionReminder.class.getName());
	
	@Test
	public static void verify_effectiveDate_in_InspectionRemider() throws IOException, AWTException, InterruptedException
	{
