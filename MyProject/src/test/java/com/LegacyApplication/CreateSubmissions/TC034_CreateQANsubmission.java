...
public class TC034_CreateQANsubmission extends TestBase {

public static final Logger log= Logger.getLogger(TC034_CreateQANsubmission.class.getName());
	
	@Test
	public static void verify_running_outofpolicynumbers_QAN() throws IOException, InterruptedException, AWTException
	{
		...
		AutoRenewalBrokerFeeMethods.fill_price_indicatorandeligibility_info(2);
		...
		AutoRenewalBrokerFeeMethods.save_ratingWorkSheet("new","Submission Id",2);
		GenericMethods.close_browser_window();
		AutoRenewalBrokerFeeMethods.change_status("Submission Id","Status_OkToBind",2);
		WaitMethods.wait_in_seconds(5);
		AutoRenewalBrokerFeeMethods.change_status("Submission Id","Status _Sold",2);
		WaitMethods.wait_in_seconds(5);
