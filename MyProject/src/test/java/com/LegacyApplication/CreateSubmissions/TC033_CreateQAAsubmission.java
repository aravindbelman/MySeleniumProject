...
public class TC033_CreateQAAsubmission extends TestBase {
	
	public static final Logger log= Logger.getLogger(TC033_CreateQAAsubmission.class.getName());
	
	@Test
	public static void verify_running_outofpolicynumbers_QAA() throws IOException, InterruptedException, AWTException
	{
