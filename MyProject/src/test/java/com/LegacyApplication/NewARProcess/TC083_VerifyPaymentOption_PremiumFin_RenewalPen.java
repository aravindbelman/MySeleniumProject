...
public class TC083_VerifyPaymentOption_PremiumFin_RenewalPen extends TestBase{
	
public static final Logger log=Logger.getLogger(TC083_VerifyPaymentOption_PremiumFin_RenewalPen.class.getName());
	
	@Test
	public void verify_PaymentOptExists_RenewalSub_PremiumFinance() throws Exception
	{
