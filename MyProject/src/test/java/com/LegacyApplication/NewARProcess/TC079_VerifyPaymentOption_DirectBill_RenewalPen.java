...
public class TC079_VerifyPaymentOption_DirectBill_RenewalPen  extends TestBase {
	
	public static final Logger log=Logger.getLogger(TC079_VerifyPaymentOption_DirectBill_RenewalPen.class.getName());
