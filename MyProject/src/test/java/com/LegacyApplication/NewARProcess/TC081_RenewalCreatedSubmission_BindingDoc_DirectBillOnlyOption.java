...
public class TC081_RenewalCreatedSubmission_BindingDoc_DirectBillOnlyOption extends TestBase {
	
public static final Logger log=Logger.getLogger(TC081_RenewalCreatedSubmission_BindingDoc_DirectBillOnlyOption.class.getName());
	
	@Test
	public void NormalAgency_RenewalCreated_DirectBillOnlyOption() throws Exception
	{
		...
		WaitMethods.wait_in_seconds(5);
		GenericMethods.navigate_to_next_window();
		AutoRenewalBrokerFeeMethods.verify_PaymentOptionRenewalCreatedDirectBillonly();
