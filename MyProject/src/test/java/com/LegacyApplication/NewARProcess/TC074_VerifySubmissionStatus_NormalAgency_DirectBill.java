...
public class TC074_VerifySubmissionStatus_NormalAgency_DirectBill extends TestBase {
	
	public static final Logger log=Logger.getLogger(TC074_VerifySubmissionStatus_NormalAgency_DirectBill.class.getName());
	...
	public void review_submissionStatus_NormalAgency_DirectBill() throws InterruptedException, IOException, AWTException
	{
		...
		HomePageMethods.login_as_admin();
		WaitMethods.wait_in_seconds(5);
	    AutoRenewalBrokerFeeMethods.verify_renewal_status("Renewal Submission Id", 4);
	    ...
	    AutoRenewalBrokerFeeMethods.verify_important_renewalInfo(4);
	    AutoRenewalBrokerFeeMethods.verify_renewalLetter_paymentInfo("direct bill", 1);
	    WaitMethods.wait_in_seconds(2);
			
		log.info("<===========Completed verifying submission status of special agency Test===========> ");
	}
