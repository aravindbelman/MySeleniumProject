...
public class TC076_VerifySubmissionStatus_NormalAgency_PremiumFinance extends TestBase {
	
	public static final Logger log=Logger.getLogger(TC076_VerifySubmissionStatus_NormalAgency_PremiumFinance.class.getName());
	
	@Test
	public void review_submissionStatus_NormalAgency_PremiumFinance() throws InterruptedException, IOException, AWTException
	{
		log.info("<===========Started verifying submission status of Normal Agency with Premium Finance as payment option Test===========> ");
		initialize_chrome("Agency_Url");
		InitializeElements.initialize_elements();
		HomePageMethods.login_as_agency(Locations.GL_AR_TestData, "AR_Agency_Info","Agency_Username","Agency_Password",6);
		...
		HomePageMethods.login_as_admin();
		WaitMethods.wait_in_seconds(5);
	    AutoRenewalBrokerFeeMethods.verify_renewal_status("Renewal Submission Id", 6);
		...
		log.info("<===========Completed verifying submission status of Normal Agency with Premium Finance as payment option Test===========> ");
	}
