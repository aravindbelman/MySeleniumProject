...
public class TC075_VerifySubmissionStatus_NormalAgency_AgencyFinance extends TestBase {
	
	public static final Logger log=Logger.getLogger(TC075_VerifySubmissionStatus_NormalAgency_AgencyFinance.class.getName());
	
	@Test
	public void review_submissionStatus_NormalAgency_AgencyFinance() throws InterruptedException, IOException, AWTException
	{
		log.info("<===========Started verifying submission status of Normal Agency with Agency Finance as payment option Test===========> ");
		...
		log.info("<===========Completed verifying submission status of Normal Agency with Agency Finance as payment option Test===========> ");
	}
